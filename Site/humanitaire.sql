...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 10 Décembre 2015 à 14:25
...
CREATE TABLE IF NOT EXISTS `camp` (
  ...
  PRIMARY KEY (`id_camp`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cette table reference les donnees sur le camp ' AUTO_INCREMENT=19 ;

--
-- Contenu de la table `camp`
--

INSERT INTO `camp` (`id_camp`, `nom`, `localisation`, `coodonneesGeo`, `nbPlaces`, `nbMedecins`) VALUES
(4, 'Liberty', 'Europe Nord', '', 75, 12),
(5, 'Death Line', 'Europe Sud', '', 100, 10),
(6, 'Noname', 'Europe Est', '', 100, 5),
(7, 'ABCenter', 'Europe Ouest', '', 50, 2),
(8, 'SideOuest', 'Europe Ouest', '', 200, 10),
(9, 'Freedom', 'Afrique Nord', '', 200, 20),
(10, 'SafeCamp', 'Afrique Sud', '', 300, 40),
(11, 'CampNous', 'Afrique Est', '', 100, 15),
(12, 'AfrOuest', 'Afrique Ouest', '', 220, 12),
(13, 'NordAsia', 'Asie Nord', '', 100, 15),
(14, 'IndiaCamp', 'Asie Sud', '', 350, 35),
(15, 'EstSideAsia', 'Asie Est', '', 270, 15),
(16, 'WestStorie', 'Asie Ouest', '', 200, 10),
(17, 'BresilianCamp', 'Amerique Sud', '', 100, 5),
(18, 'LatinAmerica', 'Amerique Centre', '', 200, 14);
...
CREATE TABLE IF NOT EXISTS `personne` (
  ...
  PRIMARY KEY (`id_pers`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cette table reference les informations sur les refugiees' AUTO_INCREMENT=231 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cette table reference les dates de sorties et d''entree dans le camp des refugiee' AUTO_INCREMENT=6 ;
