	...
	<p><BR> Veuillez donner les cacteristiques de la personne : </p>
...
<!--	label       // pour le CSS
{
	...
	<form method="post" action="ResrecherchePers.php">
    			...
    			<BR><p>
				     <label>Sexe</label>:<br>
				     <input type="radio" name="sexe" value="H" id="Homme" /> <label for="moins15">Homme</label><br />
				     <input type="radio" name="sexe" value="F" id="Homme" /> <label for="Homme">Femme</label><br />
			    </p>
